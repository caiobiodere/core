...
function combineObservables(observables) {
    var observableArray = mapArrayFromKeysOf(observables, function (key) {
        return observables[key].pipe(map(function (value) { return [key, value]; }));
    });
    return combineLatest.apply(void 0, observableArray).pipe(map(toupleArrayToDict));
}
...
function getObservableState(inputs) {
    ...
    return inputs ? combineObservables(inputs) : of({});
}
    ...
    return function wrapWithConnect(WrappedComponent) {
        return /** @class */ (function (_super) {
            ...
            function ConnectState(props) {
                ...
                _this.propsObservable = new ReplaySubject(1);
